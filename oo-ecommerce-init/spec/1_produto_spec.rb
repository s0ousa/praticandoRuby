...
describe 'Produto' do
  it "1: deveria criar um Produto de categoria específica" do
    nome = 'Cabo HDMI'
  ...
  it "2: deveria criar um objeto de categoria Geral por padrão" do
    nome = 'Teclado'
    preco = 100
    estoque = 3
  ...
  it "3: deveria adicionar quantidade em estoque" do
    nome = 'Teclado'
    preco = 100
    estoque = 3
    produto = Produto.new(nome: nome, preco: preco, estoque: estoque)
  ...
  it "4: deveria subtrair quantidade em estoque" do
    nome = 'Teclado'
    preco = 100
    estoque = 7
    produto = Produto.new(nome: nome, preco: preco, estoque: estoque)
