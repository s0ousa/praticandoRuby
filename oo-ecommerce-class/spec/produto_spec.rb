...
describe 'Produto' do
  it '1: deveria conseguir criar um objeto Produto de categoria específica' do
    nome = 'Cabo HDMI'
  ...
  it '2: deveria conseguir criar um objeto Produto de categoria Geral por padrão' do
    nome = 'Teclado'
    preco = 100
    estoque = 3
